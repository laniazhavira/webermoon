export const initialNodes = [
    {
      ...
      data: { label: 
        <label>
          ...
          Edge OTN 2025
        </label>, link: '/tabel2', type: 'input' },
      position: { x: -600, y: 400 },
    },
    {
      id: '2',
      type: 'hyperLink',
      data: { label: 'Not Yet', link: '/tabel2/notyet', type: 'default', value:'' },
      position: { x: 200, y: -13 },
    },
    {
      id: '3',
      type: 'hyperLink',
      data: { label: 'Survey', link: '/tabel2/survey', type:'default' },
      position: { x: 200, y: 238 },
    },
    {
      id: '4',
      type: 'hyperLink',
      data: { label: 'Delivery', link: '/tabel2/delivery', type: 'default' },
      position: { x: 200, y: 489 },
    },
    {
      id: '5',
      type: 'hyperLink',
      data: { label: 'Instalasi', link: '/tabel2/instalasi', type: 'default' },
      position: { x: 200, y: 740 },
    },
    {
      id: '6',
      type: 'hyperLink',
      data: { label: 'Integrasi', link: '/tabel2/integrasi', type: 'default' },
