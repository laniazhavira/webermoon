...
import { initialNodes } from '../config1/nodes';
import { initialEdges } from '../config1/edges';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v2/get-data`, {
