...
const RequestUpdateSite1 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v2/data/site/form-detail/${idSite}`, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const jwtToken = GetJWT();
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v2/request/site/${idSite}/add`, formData, {
                headers: { Authorization: `Bearer ${jwtToken}`, "Cache-Control": "no-cache" },
            });
