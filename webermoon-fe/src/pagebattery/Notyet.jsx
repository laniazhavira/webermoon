  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v2/data/table`, {
      ...
      <div className="max-w-[100%] mx-auto">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-3/5 bg-white rounded-xl shadow-lg overflow-hidden flex">
            <div className="p-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Kurva S Status Not Yet CSF Battery </h2>
              <div className="overflow-x-auto">
