  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v2/data/site`,  {
...
const handleSiteClick = (idSite) => {
  navigate(`/tabel1/site/detail/${idSite}`);
};

const addSite = () => {
  navigate("/tabel1/site/add", { state: { selectedWitel, selectedSto} });
};
