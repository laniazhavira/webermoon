...
const AddSite1 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const requiredFields = ["mitra", "name"]; // specify required fields
            ...
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v2/data/site/add`, body, {
