    ...
    const navItems = {
        admin: [
            { 
                name: "Table", 
                subItems: [
                    { name: "Main", link: "/tabel" },
                    { name: "Not Yet", link: "/tabel/notyet" },
                    { name: "Survey", link: "/tabel/survey" },
                    { name: "Delivery", link: "/tabel/delivery" },
                    { name: "Instalasi", link: "/tabel/instalasi" },
                    { name: "Integrasi", link: "/tabel/integrasi" }
                ] 
            },
            { name: "Request", link: "/tabel/request" },
            { name: "Upload", link: "/miniolt/upload" },
            { name: "Logout" }
        ],
        mitra: [
            { 
