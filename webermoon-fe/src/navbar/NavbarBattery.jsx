    ...
    const navItems = {
        admin: [
            { 
                name: "Table", 
                subItems: [
                    { name: "Main", link: "/tabel1" },
                    { name: "Not Yet", link: "/tabel1/notyet" },
                    { name: "Survey", link: "/tabel1/survey" },
                    { name: "Delivery", link: "/tabel1/delivery" },
                    { name: "Instalasi", link: "/tabel1/instalasi" },
                    { name: "Integrasi", link: "/tabel1/integrasi" }
                ] 
            },
            { name: "Request", link: "/tabel1/request" },
            { name: "Upload", link: "/battery/upload" },
            { name: "Logout" }
        ],
        mitra: [
            { 
