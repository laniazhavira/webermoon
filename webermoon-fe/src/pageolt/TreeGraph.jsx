...
import { initialNodes } from '../config3/nodes';
import { initialEdges } from '../config3/edges';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v4/get-data`, {
