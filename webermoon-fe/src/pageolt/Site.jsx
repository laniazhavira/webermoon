  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v4/data/site`,  {
...
const handleSiteClick = (idSite) => {
  navigate(`/tabel3/site/detail/${idSite}`);
};

const addSite = () => {
  navigate("/tabel3/site/add", { state: { selectedWitel, selectedSto} });
};
