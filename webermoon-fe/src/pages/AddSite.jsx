...
const AddSite = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v1/data/site/add`, body, {
    ...
    return (
        <div className=" h-[calc(100vh-111px)] min-w-screen p-8 bg-gray-200">
