...
const Tabel = () => {
  ...
  const handleRegionClick = (region) => {
    navigate("/tabel/witel", { state: { selectedRegion: region } });
  };
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  {Object.entries(payload).map(([key, value]) => {
                    ...
                    return (
                      <tr key={key} className="odd:bg-gray-100 even:bg-white hover:bg-gray-200 transition duration-150 text-center">
                        <td
