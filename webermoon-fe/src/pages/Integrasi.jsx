      ...
      <div className="max-w-[100%] mx-auto">
        ...
        <div className="flex gap-8">
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr>
                      ...
                      <th className="bg-gray-700 text-white border-b-2 border-gray-600 px-6 py-3 text-center" colSpan="2">INTEGRASI</th>
                    </tr>
                  ...
                  <tbody>
                    {payload && Object.entries(payload).map(([key, value]) => (
                      <tr key={key} className={`hover:bg-gray-100 ${key === "Total" ? 'font-bold bg-gray-100' : ''}`}>
                        ...
                        <td className="border-b border-gray-400 px-6 py-4 text-center">{value.values[8]}</td>
                        <td className="border-b border-gray-400 px-6 py-4 text-center">{value.values[9]}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="w-3/5 bg-white rounded-xl shadow-lg overflow-hidden flex">
            <div className="p-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Kurva S Status Integrasi CSF Mini OLT</h2>
              <div className="overflow-x-auto">
