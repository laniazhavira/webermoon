export const initialNodes = [
    {
      ...
      data: { label: 
        <label>
          ...
          Battery 2025
        </label>, link: '/tabel1', type: 'input' },
      position: { x: -600, y: 400 },
    },
    {
      id: '2',
      type: 'hyperLink',
      data: { label: 'Not Yet', link: '/tabel1/notyet', type: 'default', value:'' },
      position: { x: 200, y: -13 },
    },
    {
      id: '3',
      type: 'hyperLink',
      data: { label: 'Survey', link: '/tabel1/survey', type:'default' },
      position: { x: 200, y: 238 },
    },
    {
      id: '4',
      type: 'hyperLink',
      data: { label: 'Delivery', link: '/tabel1/delivery', type: 'default' },
      position: { x: 200, y: 489 },
    },
    {
      id: '5',
      type: 'hyperLink',
      data: { label: 'Instalasi', link: '/tabel1/instalasi', type: 'default' },
      position: { x: 200, y: 740 },
    },
    {
      id: '6',
      type: 'hyperLink',
      data: { label: 'Integrasi', link: '/tabel1/integrasi', type: 'default' },
