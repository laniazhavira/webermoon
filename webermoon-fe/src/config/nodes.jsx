export const initialNodes = [
    {
      ...
      data: { label: 
        <label>
          ...
          Mini OLT 2025
        </label>, link: '/tabel', type: 'input' },
      position: { x: -600, y: 400 },
    },
    {
      id: '2',
      type: 'hyperLink',
      data: { label: 'Not Yet', link: '/tabel/notyet', type: 'default', value:'' },
      position: { x: 200, y: -13 },
    },
    {
      id: '3',
      type: 'hyperLink',
      data: { label: 'Survey', link: '/tabel/survey', type:'default' },
      position: { x: 200, y: 238 },
    },
    {
      id: '4',
      type: 'hyperLink',
      data: { label: 'Delivery', link: '/tabel/delivery', type: 'default' },
      position: { x: 200, y: 489 },
    },
    {
      id: '5',
      type: 'hyperLink',
      data: { label: 'Instalasi', link: '/tabel/instalasi', type: 'default' },
      position: { x: 200, y: 740 },
    },
    {
      id: '6',
      type: 'hyperLink',
      data: { label: 'Integrasi', link: '/tabel/integrasi', type: 'default' },
